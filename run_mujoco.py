...
def main():
    ...
    # Use 'render_mode="human"' if args.render is True, otherwise None or "rgb_array"
    ...
    if args.algo == 'ddpg' or args.algo == 'td3':
        ...
        agent = Agent(env, args, device, obs_dim, act_dim, act_limit, sample_size=2048, train_policy_iters=10, train_vf_iters=10)
